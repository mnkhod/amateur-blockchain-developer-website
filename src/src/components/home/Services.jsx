    ...
    <div className="nes-container with-title is-centered">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-y-7 md:gap-12">
        ...
        <div className="border-4 border-black flex flex-col">
          <div className="bg-green-400 text-white py-4 grid place-content-center border-b-4 border-black h-16">
        ...
        <div className="border-4 border-black flex flex-col">
          <div className="text-black bg-gray-300 py-4 grid place-content-center border-b-4 border-black h-16">
            <p className="m-0 px-2">Membership Public Mint</p>
          </div>
        ...
        <div className="border-4 border-black flex flex-col">
          <div class="bg-blue-400 text-white py-4 grid place-content-center border-b-4 border-black h-16">
            <p className="m-0 px-3">Cheatsheets</p>
          </div>
